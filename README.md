...
AI-Powered Analysis: Powered by Google Gemini API, providing: Extraction of key topics (architectures, datasets, evaluation methods), Comparative analysis across multiple papers, Calculation of research impact metrics (h-index, i10-index, journal tiers)
